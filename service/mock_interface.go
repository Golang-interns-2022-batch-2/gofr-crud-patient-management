...
func (m *MockPatient) Delete(ctx *gofr.Context, id string) error {
	m.ctrl.T.Helper()
...
func (m *MockPatient) GetByID(ctx *gofr.Context, id string) (*models.Patient, error) {
	m.ctrl.T.Helper()
...
func (m *MockPatient) Update(ctx *gofr.Context, id string, patient *models.Patient) (*models.Patient, error) {
	m.ctrl.T.Helper()
